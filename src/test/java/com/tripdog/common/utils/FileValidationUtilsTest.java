...
/**
 * FileValidationUtils测试类
 * 验证P0-3修复：文件大小和类型限制
 */
class FileValidationUtilsTest {

    @Test
    void testValidateDocumentFile_ValidFile() {
        // 测试有效的文档文件
    ...
    @Test
    void testValidateDocumentFile_FileTooLarge() {
        // 测试文件过大
        MockMultipartFile file = new MockMultipartFile(
            "file",
            "large.pdf",
    ...
    @Test
    void testValidateDocumentFile_InvalidExtension() {
        // 测试不支持的文件扩展名
        MockMultipartFile file = new MockMultipartFile(
            "file",
            "test.exe",
    ...
    @Test
    void testValidateImageFile_ValidImage() {
        // 测试有效的图片文件
        MockMultipartFile file = new MockMultipartFile(
            "file",
            "test.jpg",
    ...
    @Test
    void testValidateImageFile_ImageTooLarge() {
        // 测试图片过大
        MockMultipartFile file = new MockMultipartFile(
            "file",
            "large.jpg",
